...
In practice, the definition is to differentiate $\v{r}$ with respect to the variable and then normalise^[As well as $\v{e}_\rho$, you might see other notations like $\hat{\v{\rho}}$.]:
$$
\begin{aligned}

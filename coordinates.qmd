...
The definition of a basis vector is the direction you move from a point in space if you increase a particular co-ordinate. So moving in the direction of $\vv{e}_x$ increases the value of $x$ but keeps $y$ constant. It's usually assumed to be a unit vector.

In practice, the definition is to differentiate $\vv{r}$ with respect to the variable and then normalise^[As well as $\vv{e}_\rho$, you might see other notations like $\hat{\vv{\rho}}$.]:
$$
\begin{aligned}
\vv{e}_\rho &= \frac{\partial \vv{r}}{\partial \rho}/\left|\frac{\partial \vv{r}}{\partial \rho}\right| 
...
$$
\begin{aligned}
\vv{e}_\phi &= \frac{\partial \vv{r}}{\partial \phi}/\left|\frac{\partial \vv{r}}{\partial \phi}\right| 
...
$$
\begin{aligned}
\vv{e}_x &= \frac{\partial \vv{r}}{\partial x}/\left|\frac{\partial \vv{r}}{\partial x}\right| 
...
$$h_\rho = \left|\frac{\partial \vv{r}}{\partial \phi}\right| = 1,$$
$$h_\phi = \left|\frac{\partial \vv{r}}{\partial \phi}\right| = \rho.$$
...
$$
\vv{r} = [x,y] = [\rho \cos \phi,\, \rho\sin\phi] = \rho \vv{e}_\rho.
$$
Where does $\phi$ appear in this expression? The answer is that it's hidden inside the $\vv{e}_\rho$. You have to know the co-ordinates to understand this position vector.
...
$$
\vv{e}_\rho \cdot \vv{e}_\phi = [\cos \phi,\,\sin\phi] \cdot [-\sin\phi,\,\cos\phi] = -\cos\phi\sin\phi + \sin\phi\cos\phi = 0.
$$
...
![](figures/f9.jpg){width=50%}

The general position vector is
$$
\vv{r} = \rho \vv{e}_\rho + z \vv{e}_z.
$$
...
![](figures/f10.jpg){width=50%}

The definition is
$$
[x,y,z] = [r\cos\phi\sin\theta,\,r\sin\phi\sin\theta,\,r\cos\theta]
$$
with $r>0$, $0\leq \theta \leq \pi$,  $0\leq\phi<2\pi$.

You can derive the following:
$$
\begin{aligned}
\vv{e}_r &= [\cos\phi\sin\theta,\,\sin\phi\sin\theta,\,\cos\theta],\\
\vv{e}_\theta &= [\cos\phi\cos\theta,\,\sin\phi\cos\theta,\,-\sin\theta],
\vv{e}_\phi &= [-\sin\phi,\,\cos\phi,\,0],\\
\end{aligned}
$$
$$
